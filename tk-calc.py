...
plus=Button(gui,text='+',fg='black',bg='red',heigh=1,width=7,command=lambda:press('+'))
...
exit=Button(gui,text='exit',fg='black', bg='red',height=1, width=7,command=lambda:quit())
